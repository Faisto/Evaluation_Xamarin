...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "EvaluationXamarin.Android.dll" comes first in this list. */
		"EvaluationXamarin.Android.dll",
		"EvaluationXamarin.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		"Prism.dll",
		...
		"EvaluationXamarin.VM.dll",
		"EvaluationXamarin.DataAPI.dll",
		"EvaluationXamarin.APIService.dll",
	};
